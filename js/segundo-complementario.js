...
function precioEnCuotas(){
   if (cuotaProducto == 6){
      ...
      alert("El precio final iva e intereces incluidos es de/los/las" + producto + " es de $" + precioFinal + " que disfrute su compra");
      return("Su cuota mensual es de $" + (precioFinal / cuotaProducto));
       ...
       alert("El precio final iva e intereces incluidos de/los/las " + producto + " es de $" + precioFinal + " que disfrute su compra");
       return("Su cuota mensual es de $" + (precioFinal / cuotaProducto));
       ...
       alert("El precio final iva e intereces incluidos de/los " + producto + " es de $" + precioFinal + " que disfrute su compra");
       return("Su cuota mensual es de $" + (precioFinal / cuotaProducto));
